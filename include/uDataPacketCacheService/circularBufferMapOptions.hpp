#ifndef UDATA_PACKET_CACHE_SERVICE_CIRCULAR_BUFFER_MAP_OPTIONS_HPP
#define UDATA_PACKET_CACHE_SERVICE_CIRCULAR_BUFFER_MAP_OPTIONS_HPP
#include <chrono>
#include <memory>
namespace UDataPacketCacheService
{
/*!
 * @class CircularBufferMapOptions "circularBuffferMapOptions.hpp"
 * @brief Defines the options for the circular buffer map.
 * @copyright Ben Baker (University of Utah) distributed under the
 *            MIT NO AI license.
 */
class CircularBufferMapOptions
{
public:
    /// @brief Constructor.
    CircularBufferMapOptions();
    /// @brief Copy constructor.
    CircularBufferMapOptions(const CircularBufferMapOptions &options);
    /// @brief Move constructor.
    CircularBufferMapOptions(CircularBufferMapOptions &&options) noexcept;
    ...
    CircularBufferMapOptions &operator=(CircularBufferMapOptions &&options) noexcept;

private:
    class CircularBufferMapOptionsImpl;
    std::unique_ptr<CircularBufferMapOptionsImpl> pImpl;
};
}
#endif
