...
class uDataPacketCacheConan(ConanFile):
   name = "uDataPacketCacheService"
   #version = "0.0.1"
   license = "MIT"
   description = "An in-memory high-speed cache for seismic data packets."
   url = "https://github.com/uofuseismo/uDataPacketCacheService"
   ...
   def package_info(self):
       self.cpp_info.libs = ["uDataPacketCacheService"]
